...
function method2() {
    ...
    document.getElementById("pop_up").innerHTML = `
        ...
        <table class="center">
            <tr><td id="option1"></td><td id="option2"></td><td id="option3"></td></tr>
            <tr><td id="option4"></td><td id="option5"></td><td id="option6"></td></tr>
            <tr><td id="option7"></td><td id="option8"></td><td id="option9"></td></tr>
        </table>`;
    setNumber();
    sol();
    $("#option1").text(a);
